     ...
     <div class="container">
         ...
         <div class="collapse navbar-collapse navbar-right" id="menu">
            <ul class="nav navbar-nav">
              ...
              <li class="<?php echo existeOpcionMenuActivaEnArray(['blog.php', 'single_post.php'])? 'active lien' : ' lien'?>"><a href="<?php echo existeOpcionMenuActivaEnArray(['blog.php', 'single_post.php'])? '#' : 'blog.php'?>"><i class="fa fa-file-text sr-icons"></i> Blog</a></li>
